...
.warning {
    border-left: solid 3px $warning-orange;
    background-color: rgba($color: $warning-orange, $alpha: .2);
    .snackbar-content {
        h5 {
...
.alert {
    border-left: solid 3px $alert-red;
    background-color: rgba($color: $alert-red, $alpha: .2);
    .snackbar-content {
        h5 {
            color: $alert-red;
        }
